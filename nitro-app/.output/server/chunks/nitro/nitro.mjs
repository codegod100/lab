...
const _sUvn6q = eventHandler((event) => {
...
const _lazy_3rmiyC = () => import('../routes/index.mjs');

const handlers = [
  { route: '', handler: _sUvn6q, lazy: false, middleware: true, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/var/home/v/lab/nitro-app/.data/kv"}));
